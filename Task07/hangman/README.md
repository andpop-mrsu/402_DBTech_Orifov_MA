...
4. **Запуск через GitHub Pages**:
    ...
    Если вы не хотите загружать проект на свой локальный компьютер, вы можете запустить игру прямо из браузера, воспользовавшись [GitHub Pages (Нажмите сюда)](https://staticnur.github.io/hangman-web). Для этого:
